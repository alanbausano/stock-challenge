  ...
  return (
    <Box>
      <Box display="flex" alignItems="center" justifyContent="space-between" mb={2}>
        ...
        >
          <ToggleButton value="5m" aria-label="5 minute interval">5m</ToggleButton>
          <ToggleButton value="15m" aria-label="15 minute interval">15m</ToggleButton>
        </ToggleButtonGroup>
      </Box>

      {items.length === 0 ? (
        <Box display="flex" justifyContent="center" alignItems="center" height={300}>
          <Typography color="text.disabled">Add crypto pairs to see the chart</Typography>
        </Box>
      ) : isLoading ? (
